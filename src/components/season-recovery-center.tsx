...
export function SeasonRecoveryCenter({ activeSeason, restorePoints }: Props) {
  ...
  return (
    <section className="mt-6 min-w-0">
      <SectionHeader
        description="Create portable season backups and restore only after reviewing an exact comparison."
      ...
      <div className="mt-5 border-y border-slate-200 py-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            className="min-h-10 rounded-md bg-slate-900 px-4 py-2 text-sm font-semibold text-white disabled:cursor-not-allowed disabled:opacity-60"
          ...
          {selectedPoint ? (
            <div className="mt-3 rounded-md border border-slate-200 bg-white px-3 py-3">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                <button
                  className="min-h-10 rounded-md border border-slate-300 px-3 py-2 text-sm font-semibold text-slate-800"
                ...
                <button
                  className="min-h-10 rounded-md bg-slate-900 px-3 py-2 text-sm font-semibold text-white disabled:opacity-60"
                  disabled={busyAction !== null}
          ...
          {!preview ? (
            ...
            <>
              ...
              <CompactNotice className="mt-4" tone="warning">
                ...
                participant registrations, driver state, and Hall of Fame data with this snapshot.
              </CompactNotice>
              ...
              <label className="mt-4 block">
                ...
                <input
                  className="w-full rounded-md border border-slate-300 px-3 py-2 text-base sm:max-w-52"
                  inputMode="numeric"
